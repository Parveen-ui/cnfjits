...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'vmi528310.contaboserver.net',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'vmi528310.contaboserver.net',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.vmi528310.contaboserver.net',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'vmi528310.contaboserver.net',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: '//vmi528310.contaboserver.net/' + subdir + 'http-bind',

    // Websocket URL
    // websocket: 'wss://vmi528310.contaboserver.net/' + subdir + 'xmpp-websocket',

    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.vmi528310.contaboserver.net',
    ...
    //     // by default uses:
    //     // 'https://vmi528310.contaboserver.net/static/oauth.html'
    //     redirectURI:
    //          'https://vmi528310.contaboserver.net/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:vmi528310.contaboserver.net:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.vmi528310.contaboserver.net',
